                        ...
                        <div class="col-md-8">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Products Flows</h3>
                                </div>
                                ...
                                <div class="panel-body feed">
                                    <section class="feed-item">
                                        ...
                                        <div class="feed-item-body">
                                            <div class="text">
                                                <a href="#">comment1</a> commented on <a href="#">What Makes Good Code Good</a>.
                                            </div>
                                    ...
                                    <section class="feed-item">
                                        ...
                                        <div class="feed-item-body">
                                            <div class="text">
                                                <a href="#">Merge request #42</a> has been approved by <a href="#">Jessica</a>.
                                            </div>
                                            <div class="time pull-left">
                                                10 h
                                            </div>
                                    ...
                                    <section class="feed-item">
                                        ...
                                        <div class="feed-item-body">
                                            <div class="text">
                                                New user <a href="#">Innocent Ogbue</a> registered.
                                            </div>
                                            <div class="time pull-left">
                                                Today
                                            </div>
