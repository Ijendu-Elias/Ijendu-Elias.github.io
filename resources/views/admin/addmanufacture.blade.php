...
<div id="container col-lg-10 col-md-offset-10" style="margin-left:1%;" >
    <ul class="breadcrumb">
        ...
        <i class="icon-angle-right"></i>
            ...
            <i class="icon-edit"></i>
            <a href="#">|<span style="color:deepskyblue; font-weight:bolder;">Add Manufacture</span></a>
        <li>
        ...
        <div class="row" style="margin-left:10%;">
            <div class="col-lg-10 col-md-offset-0">
                <form role="form" action="{{URL::to('/save_manufacture')}}" method="POST" >
                    {{ csrf_field() }}
                    <div class="form-group">
                        ...
                        <input class="form-control" name="manufacture_name" required  style=" background:black; color:white">
                    </div>
                    <div class="form-group">
                        <label>Manufacture Description</label>
                        <textarea class="form-control" rows="10"  name="manufacture_description"  required  style=" background:black; color:white"></textarea>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary  fa fa-globe">Add Manufacture</button>
