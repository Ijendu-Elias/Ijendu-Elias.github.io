      ...
      {{ csrf_field() }}
           ...
           <?php }?> 
            ...
            <div class="form-group">
              ...
              <input type="text" name="location1" class="form-control" id="inputAddress" placeholder="1234 Main St.." required>
            </div>
            <div class="form-group">
              <label for="inputAddress2">Product Location (2)</label>
              <input type="text" name="location2" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" required>
            </div>
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                    ...
                    <select name="local" id="inputLocal" class="form-control" style="margin-left:-8%">
              ...
              <div class="form-group col-md-2">
                ...
                <input type="text" name="sale_zip_code" class="form-control" id="inputZip" style="margin-left:-15%" name="zipcode" required>
              </div>
            </div>
            <div class="form-group">
              <div class="form-check">
                <label class="form-check-label" for="gridCheck"><br>
                    <input class="form-check-input" type="checkbox" id="gridCheck" name="agreed_status" checked value="1">
                      I agreed To <a href="#"> Terms & Conditions</a>
                </label>
                <div class="form-check"><br><br>
                  <label  class="form-check-input">Products description</label>
                    <textarea name="sale_description" id="" cols="30" rows="10" required></textarea>
                </div>
              </div>
            </div><br>
            <button type="submit" class="btn btn-success" style="width:10%; float:right;"><i class="fa fa-arrow-right">Next</i></button>
          </form>
        <?php }else {?>

 <!--Validation to login b4 you must sell your products-->
    ...
    @endif
                    ...
                    <input type="email" placeholder="Email Address" value="{{old('customer_email')}}" name="customer_email"required/>
                            ...
                            <button type="submit" class="btn btn-default" style="width:150%; ">Submit Request</button>
                        </form>
                    </div><!--/sign up form-->
                </div>
            </div>
...
$('#inputState').on('change', function(e) {
  ...
  let local = states_in_nigeria.find(state_in_nigeria => {
    return state_in_nigeria.state.name === selected_state;
  });
